...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen bg-dark-900">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-dark-800 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
      ...
      >
        <div className="flex items-center justify-between h-16 px-6 border-b border-dark-700">
          <div className="flex items-center">
            ...
            <h1 className="text-xl font-bold text-white">ROAD SAFETY GUARD</h1>
          </div>
          <button
            onClick={() => setSidebarOpen(false)}
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="relative">
                  <button className="flex items-center text-dark-400 hover:text-white transition-colors duration-200">
                  ...
                  {/* Dropdown menu */}
                  <div className="absolute right-0 mt-2 w-48 bg-dark-800 rounded-md shadow-lg border border-dark-700 hidden group-hover:block">
                    <div className="py-1">
                      <button
                        onClick={logout}
